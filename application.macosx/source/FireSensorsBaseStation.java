...
public class FireSensorsBaseStation extends PApplet {
...
class FireSensorUnit {
  ...
  //GImageButton button;
  //GLabel label;
  //String[] buttonFiles = new String[] {"button1.png", "button2.png", "button3.png"};
  ...
  public FireSensorUnit(PApplet parent, int ID) {
    ...
    textFont(font);
    //button = new GImageButton(parent, width*0.04, plotPosY + plotSizeY*.1, buttonFiles);
...
class FireSerialManager {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "FireSensorsBaseStation" };
    if (passedArgs != null) {
